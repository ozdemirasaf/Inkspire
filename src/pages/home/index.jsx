        ...
        <div className="p-4 flex flex-col items-center gap-4 justify-center">
            ...
            <div className="w-full sm:w-[20rem] md:w-[25rem] border-2 border-[#2F3336] bg-[#2D2B30] mb-4 rounded-xl p-4 flex flex-col hover:shadow-custom transition-shadow group">
                <div className="flex justify-center relative">
                    <img src="/movies-books-img/besOrdu.jpg" className="w-full rounded-md h-[19.89rem] object-cover object-top" alt="Hobbit: Beş Ordunun Savaşı" />
                ...
                <div className="mt-3">
                    <div className="flex items-center justify-center font-sm font-semibold text-white">
                        <h2 className="text-base sm:text-lg md:text-xl">Hobbit</h2>
                    </div>

                    <div className="mt-1 text-[#bfbfbf] text-sm sm:text-base">
                        <p className="leading-6">
                            12 Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasi fugiat possimus dolores. Dolorem cum quasi minus sunt!
                        </p>
                    </div>

                    <div className="mt-5 flex gap-4 items-center">
                        <div className="bg-black h-[4rem] w-[4rem] sm:h-[5rem] sm:w-[5rem] rounded-full flex items-center justify-center">
                            <img src="/images/boy.png" className="w-[3rem] sm:w-[4.063rem] p-1.5" alt="Profile User" />
                        </div>
                        <div className="flex flex-col gap-2">
                            <h4 className="text-white text-sm sm:text-base">User1231</h4>
                            <p className="text-[#bfbfbf] text-xs sm:text-sm">Ekim 26, 2024</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-5 flex items-center justify-center gap-4 sm:gap-7">
                    <Link>
                        <div className="flex gap-1.5 items-center">
                            ...
                            <span className="text-[#ffffffc6] font-medium text-[14px] sm:text-[16px]">13k</span>
                        </div>
                    </Link>
                    ...
                    <Link>
                        <div className="flex gap-1.5 items-center">
                            ...
                            <span className="text-[#ffffffc6] font-medium text-[14px] sm:text-[16px]">3k</span>
                        </div>
                    </Link>
