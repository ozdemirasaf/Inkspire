...
const sidebarMenu = [
...

    {
        ...
        icon: {
            ...
            active: (
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
...

    {
        ...
        icon: {
            passive: (
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6" viewBox="0 0 24 24" fill="currentColor" stroke="none" stroke-width="1.5">
